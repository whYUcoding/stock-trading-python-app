...
with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
    fieldnames = ['ticker', 'name', 'market', 'locale', 'primary_exchange', 'type', 'active', 'currency_name', 'cik', 
...
example_ticker = {'ticker': 'AAAU', 'name': 'Goldman Sachs Physical Gold ETF Shares', 'market': 'stocks', 'locale': 'us', 
'primary_exchange': 'BATS', 'type': 'ETF', 'active': True, 'currency_name': 'usd', 'cik': '0001708646', 'composite_figi': 'BBG00LPXX872', 'share_class_figi': 'BBG00LPXX8Z1', 'last_updated_utc': '2025-11-08T07:06:06.688448844Z'}
